...
| [0003](0003-large-payloads-and-shared-methods.md) | Establish the real metadata ceiling before choosing a storage mechanism; shared methods resolve-copy-freeze at root creation | Accepted, storage mechanism open |

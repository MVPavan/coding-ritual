> Historical snapshot captured 2026-09-10 before context cleanup.
> Version-specific observations and old Apply instructions below are evidence,
> not current policy. Use `.repo-context/learnings.md` for scoped guidance.

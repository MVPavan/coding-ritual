"""The §12 execution band: one active crew per repo path, ever.
...
that makes "one active crew" true; recorded provenance (`workspace.py`) is
the other.
"""
...
_MSG_BAND_HELD: Final[str] = (
    "the §12 in-repo execution band at {path} is held by another crew"
)
...
class BandLock:
    ...
    def acquire(self) -> None:
        """Take the band, or refuse immediately — never queue behind a crew."""

...
checks=(tests/test_canonical_and_pinning.py tests/test_foreman_resolution.py tests/test_foreman_inputs.py tests/test_foreman_envelope.py tests/test_foreman_inspect.py tests/test_profiles_command.py tests/test_profiles_git_isolation.py tests/test_inspector_sandbox.py tests/test_inspector_sandbox_bound.py)

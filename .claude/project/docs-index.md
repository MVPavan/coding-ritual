...
| `my_harness/<plugin>/README.md` | Working inside a specific plugin |
| `my_harness/mvp-plugin/skills/harness-adopt/SKILL.md` | Adapting the harness overlay to a repo |

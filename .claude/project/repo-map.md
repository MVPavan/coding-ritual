...
| `mvp-harness/plugins/codex-adapter/` | Legacy Codex bridge plugin — **do not use**; call the Codex CLI directly (`tools.md` §Running Codex): `scripts/codex-run.mjs`, `roles/`, `commands/`, `skills/codex-runner/` |
